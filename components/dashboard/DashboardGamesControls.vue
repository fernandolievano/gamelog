<template>
  <div class="flex flex-col mb-6">
    ...
    <div v-if="filters.q"
      class="mt-3 flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 ml-2 md:ml-0 fade-in">
      <span>Searching for <span class="text-gray-500 dark:text-gray-200 font-semibold italic">"{{ filters.q
      }}"</span></span>
      <span class="text-gray-600">|</span>
      <button @click="clearSearch" class="text-rose-300  cursor-pointer transition-colors hover:text-rose-400">
        Clear search
      </button>
    </div>
